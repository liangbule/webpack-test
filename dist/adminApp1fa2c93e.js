      ...
      a: {
        ...
        if (f.isDehydrated) {
          if (f = {
            ...
            b = jj(a, b, d, c, e);
            break a;
          } else for (Yg = Ff(b.stateNode.containerInfo.firstChild), Xg = b, N = !0, Zg = null, c = sh(b, null, d, c), b.child = c; c;) c.flags = c.flags & -3 | 4096, c = c.sibling;
        } else {
          gh();
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      return /*#__PURE__*/react.createElement("div", {
        className: "admin"
      }, "Search DOM", /*#__PURE__*/react.createElement("span", {
        className: "lessStyle"
      }, "\u6211\u662Fless"), /*#__PURE__*/react.createElement("img", {
        className: "imgLogo",
        src: logo
      }));
    }
...
root.render( /*#__PURE__*/react.createElement(Search, null)); // react 18 已弃用
// ReactDOM.render(
//     <Search />,
